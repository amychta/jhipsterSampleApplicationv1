...
public class JhipsterSampleApplicationv1App {

    private static final Logger log = LoggerFactory.getLogger(JhipsterSampleApplicationv1App.class);

    private final Environment env;

    public JhipsterSampleApplicationv1App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterSampleApplicationv1.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterSampleApplicationv1App.class);
